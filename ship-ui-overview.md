...
<img src = "images/steps ui.png">

The white boxes represents your ships **Steps**. 

* A completely filled white box represents 1 **Active Step**. 

* An empty box represents 1 **Suppressed Step**.

* If you hired a specialist, it's icon will appear in one of these steps.